...
"""
This code has been taken from VeSPA and modified for use here by Max Chandler
https://scion.duhs.duke.edu/svn/vespa/trunk/vespa/analysis/src/fileio/dicom_siemens.py
...
#     params["frequency"] = float(ptag_img.get("ImagingFrequency", 0)) * 1e6
#
#     inversion_time = ptag_img.get("InversionTime", 0)
#     if len(inversion_time):
#         inversion_time = float(inversion_time)
#     else:
#         inversion_time = -1
#
#     params["inversion_time_1"] = inversion_time
